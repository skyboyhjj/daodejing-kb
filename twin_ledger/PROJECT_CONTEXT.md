...
| 模型 | DeepSeek（TRAE 任务对话框可选） | 与生产不同模型（GLM-5.2 火山方舟 / kimi-k3 等） |
| 温度 | **0.8** | **0.2**（低） |
| top_p | **0.9** | **0.8** |
| max_tokens | **16384** | **4096** |
| 上下文 | 长（原文、考辨、互文、旧读解） | 短（只读提交物摘要） |
...
> 生产炉参数已确认（2026-08-15）：temperature=0.8, top_p=0.9, max_tokens=16384。审阅炉参数已确认（2026-08-19）：temperature=0.2, top_p=0.8, max_tokens=4096，GLM-5.2 火山方舟/kimi-k3 双模型对比选型。
...
|----|:--:|:--:|:--:|:--:|:--:|------|
| ch02 | 有 | ✅ | ✅ | ✅ | ✅ | 天下皆知 · 20砖 0拒收 · 5静默 · 74回灌 |
| ch03 | 有 | ✅ | ✅ | ✅ | ✅ | 不尚贤 · 20砖 0拒收 · 0静默 · 228回灌 |
| ch04 | 有 | ✅ | ✅ | ✅ | ✅ | 道冲 · 2砖 5拒收 · 0静默 · 308回灌 |
| ch05 | 有 | ✅ | ✅ | ✅ | ✅ | 天地不仁 · 8砖 0拒收 · 0静默 · 350回灌 |
| ch06 | 有 | ✅ | ✅ | ✅ | ✅ | 谷神不死 · 10砖 0拒收 · 0静默 · 382回灌 |
| ch07 | 有 | ✅ | ✅ | ✅ | ✅ | 天长地久 · 25砖 1拒收 · 0静默 · 422回灌 |
| ch09 | 有 | ✅ | ✅ | ✅ | ✅ | 持而盈之 · 14砖 0拒收 · 0静默 · 522回灌 |
| ch10 | 有 | ✅ | ✅ | ✅ | ✅ | 载营魄抱一 · 30砖 0拒收 · 0静默 · 578回灌 |
